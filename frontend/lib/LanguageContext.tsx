...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const translations: Record<string, Record<string, string>> = {
    hi: {
      ...
      "Opening Schemes.": "योजनाएं खोल रहे हैं।",
      "Opening Grievance.": "शिकायत पोर्टल खोल रहे हैं।",
      "Opening Dashboard.": "डैशबोर्ड खोल रहे हैं।",
      "Checking eligibility.": "पात्रता की जांच कर रहे हैं।",
      "Opening AI Chat.": "एआई चैट खोल रहे हैं।",
      "I am having trouble connecting right now. Please try again.": "अभी कनेक्शन में समस्या हो रही है। कृपया पुनः प्रयास करें।",
      "Yes, I am listening. Please tell me your command.": "हां, मैं सुन रहा हूं। कृपया अपना आदेश बताएं।",
      "Namaste! I am SETU. How can I help you?": "नमस्ते! मैं सेतु हूँ। मैं आपकी कैसे मदद कर सकता हूँ?",
      "Say": "बोलें",
      "Transcript": "ट्रांसक्रिप्ट",
      "One Moment...": "एक पल...",
      "Something went wrong": "कुछ गलत हो गया",
      "What government service do you need?": "आपको किस सरकारी सेवा की आवश्यकता है?",
      "How can I assist you today?": "मैं आज आपकी कैसे सहायता कर सकता हूँ?",
      "View Schemes": "योजनाएं देखें",
      "BPL Assist": "बीपीएल सहायता",
    ...
    te: {
      ...
      "Opening Schemes.": "పథకాలు తెరుస్తున్నాము.",
      "Opening Grievance.": "ఫిర్యాదుల పోర్టల్ తెరుస్తున్నాము.",
      "Opening Dashboard.": "డాష్‌బోర్డ్ తెరుస్తున్నాము.",
      "Checking eligibility.": "అర్హతను తనిఖీ చేస్తున్నాము.",
      "Opening AI Chat.": "AI చాట్ తెరుస్తున్నాము.",
      "I am having trouble connecting right now. Please try again.": "ప్రస్తుతం కనెక్షన్‌లో సమస్య ఉంది. దయచేసి మళ్ళీ ప్రయత్నించండి.",
      "Yes, I am listening. Please tell me your command.": "అవును, నేను వింటున్నాను. దయచేసి మీ ఆదేశాన్ని చెప్పండి.",
      "Namaste! I am SETU. How can I help you?": "నమస్కారం! నేను సేతు. నేను మీకు ఎలా సహాయపడగలను?",
      "Say": "చెప్పండి",
      "Transcript": "ట్రాన్స్క్రిప్ట్",
      "One Moment...": "ఒక క్షణం...",
      "Something went wrong": "ఏదో తప్పు జరిగింది",
      "What government service do you need?": "మీకు ఏ ప్రభుత్వ సేవ అవసరం?",
      "How can I assist you today?": "నేను ఈ రోజు మీకు ఎలా సహాయపడగలను?",
      "View Schemes": "పథకాలను చూడండి",
      "BPL Assist": "BPL సహాయం",
